    ...
    return `<div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center"><a class="btn btn-success mt-auto" onClick="javascript:addProductsCart('${produto.id}', $('#input${produto.id}').val())">Adicionar <i class="bi bi-cart-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>`
